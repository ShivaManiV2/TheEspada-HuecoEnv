...
- **3 Agent Roles:** Producer, Allocator, Critic — communicating via structured JSON trade protocol
...
|------|----------|----------|
| **Producer** | Consumes Compute + Data → generates artifact score | Maximize artifact quality via optimal resource ratios |
...
| 1 | 30% | 10 episodes | — |
| 2 | 20% | 15 episodes | — |
| 3 | 20% | 5 episodes | One resource type disabled |
...
└── data/                       # Simulation logs & world memory
```
